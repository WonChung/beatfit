...
- GitHub Actions runs backend checks against an isolated PostgreSQL test
  ...
  platform-specific build/export checks. Pull-request dependency review runs
  on this public repository and rejects dependency changes that introduce known
